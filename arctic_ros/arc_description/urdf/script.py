...
# file_path = os.path.dirname(os.path.abspath(__file__)) + "/Arctic_Long.urdf.xacro"
file_path = os.path.dirname(os.path.abspath(__file__)) + "/Polygon.urdf"
...
def main():
    try:
        ...
        with open (file_path, 'r') as f:
            ...
            # new_data = old_data.replace('../meshes', 'package://arc_description/meshes/Long')
            new_data = old_data.replace('../meshes', 'package://arc_description/meshes/Polygon')
